                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <li data-filter=".jabones">Jabones</li>
                            <li data-filter=".dental">Dental</li>
                            <li data-filter=".cremas">Cremas</li>
                        </ul>
                    </div>
                </div>
            </div>
