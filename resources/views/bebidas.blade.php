    ...
    <div class="product-section mt-150 mb-150">
        <div class="container">
                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <li data-filter=".gaseosas">Gaseosas</li>
            ...
            @foreach ($bebidas as $bebida)
                <div class="col-lg-4 col-md-6 text-center {{$bebida->categoria}}">
					<div class="single-product-item">
						...
						<h3>{{$bebida->nombre}}</h3>
						<p class="product-price"><span>{{$bebida->unidad}}</span> S/{{$bebida->precio}}</p>
