@extends('layout')
@section('titulo', 'embutidos y fiambres')
@section('content')
	...
	<div class="product-section mt-150 mb-150">
		<div class="container">
                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <li data-filter=".jamones">Jamones</li>
                            <li data-filter=".salames">Salames</li>
                            <li data-filter=".chorizos">Chorizos</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            @foreach ($embutidos as $embutido)
				<div class="col-lg-4 col-md-6 text-center {{$embutido->categoria}}">
